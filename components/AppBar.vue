<template>
  ...
  >
    <v-list-item
      prepend-avatar="/images/logo/smbmatriclogo.webp"
      title="SMB Matric."
...
const logo = computed(() => {
  if (smAndDown.value) {
    return { url: "/images/logo/smbmatrictextlogo.webp", width: 290 };
  } else {
    return { url: "/images/logo/smbmatriclogo.webp", width: 75 };
  }
});
</script>
