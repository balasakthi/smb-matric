<template>
  ...
  <MessageItem
    ...
    :messageData="{
      ...
      imageUrl: 'images/management/smb-vice-principal.webp',
      imageWidth: 400,
    }"
  />
</template>
